...
<div class="video-carousel">
    ...
    <div class="carousel-slide {{ $index == 0 ? 'active' : '' }}">
        <a href="{{ $banner->click_url ?? '#' }}" class="video-link">
...
<div class="container main-content">
    ...
    <div class="row mb-5">
        <div class="col-12">
            <img src="{{ asset('images/car-banner.jpg') }}" class="img-fluid rounded shadow-sm" alt="Car Banner">
        </div>
    </div>
    ...
    <section class="featured-cars">
                ...
                <div class="card h-100 border-0 shadow-sm hover-shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <span class="text-warning me-1">{{ $car['rating'] }}</span>
                            <div class="text-warning">
                                <i class="fas fa-star"></i>
                            </div>
                            <span class="text-muted ms-1">({{ $car['reviews'] }} reviews)</span>
                        </div>
                        <div class="mb-3">
                            <span class="fw-bold">${{ number_format($car['price']) }}</span>
                        </div>
                        <div class="mb-3">
                            <span class="badge bg-success">{{ $car['engine'] }}</span>
        ...
        <div class="text-center mt-5">
            <a href="{{ route('cars') }}" class="btn btn-primary">Show more products</a>
        </div>
    </section>
</div>
