            ...
            <div class="flex flex-col w-64 bg-gray-800">
                ...
                <div class="flex flex-col flex-grow overflow-y-auto">
                    <nav class="flex-1 px-2 py-4 space-y-1">
                        ...
                        @endif
                        <a href="{{ route('admin.social-media.index') }}" class="flex items-center px-2 py-2 text-sm font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white {{ request()->routeIs('admin.social-media*') ? 'bg-gray-700' : '' }}">
                ...
                <div class="p-6 overflow-y-auto" style="height: calc(100vh - 64px);">
                    ...
                    <div id="validation-errors" class="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 mb-4 rounded shadow-sm">
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <p class="text-sm font-medium text-red-800">There were {{ $errors->count() }} error(s) with your submission</p>
