...
@section('page-heading', 'Edit Social Media Link')
...
<div class="bg-white rounded-lg shadow-md p-6">
    ...
    <form action="{{ route('admin.social-media.update', ['social_medium' => $social_medium->id]) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" id="platform_name" name="platform_name" value="{{ old('platform_name', $social_medium->platform_name) }}"
            ...
            <div>
                ...
                <input type="url" id="url" name="url" value="{{ old('url', $social_medium->url) }}"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div class="grid grid-cols-12 gap-2 items-center">
                    <div class="col-span-1 flex justify-center">
                        <div class="w-10 h-10 flex items-center justify-center bg-gray-100 rounded-md">
                            <i id="icon-preview" class="{{ $social_medium->icon_class }} text-xl text-gray-700"></i>
                        </div>
                    </div>
                    <div class="col-span-9">
                        <input type="text" id="icon_class" name="icon_class" value="{{ old('icon_class', $social_medium->icon_class) }}"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            ...
            <div>
                ...
                <input type="number" id="display_order" name="display_order" value="{{ old('display_order', $social_medium->display_order) }}" min="0"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            </div>
        </div>
        ...
        <div class="mt-4">
            <div class="flex items-center">
                <input type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $social_medium->is_active) ? 'checked' : '' }}
        ...
        <div class="mt-4">
            <div class="flex items-center">
                <input type="checkbox" id="show_on_car_detail" name="show_on_car_detail" value="1" {{ old('show_on_car_detail', $social_medium->show_on_car_detail) ? 'checked' : '' }}
                    class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
