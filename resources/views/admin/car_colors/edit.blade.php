...
<div class="bg-white rounded-lg shadow-md p-8 max-w-3xl mx-auto">
    <form action="{{ route('admin.car_colors.update', $carColor) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="col-span-2">
                ...
                <div class="flex items-center space-x-4">
                    <div id="color_preview" class="h-24 w-24 border border-gray-300 rounded-lg shadow-sm transition-all" style="background-color: {{ old('hex_code', $carColor->hex_code) }}"></div>
            ...
            <div class="col-span-2 flex items-center mt-2">
                <input type="checkbox" name="is_active" id="is_active"
                       ...
                       {{ old('is_active', $carColor->is_active) ? 'checked' : '' }}>
        ...
        <div class="flex justify-end gap-2 mt-8">
            ...
            <button type="submit" class="px-6 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 font-semibold shadow transition-all">Update Car Color</button>
        </div>
    </form>
</div>
