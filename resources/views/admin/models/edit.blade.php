...
<div class="bg-white rounded-lg shadow-md p-8 max-w-3xl mx-auto">
    <form action="{{ route('admin.makes.update', $make) }}" method="POST">
        ...
        <div class="flex justify-end gap-2 mt-8">
            <a href="{{ route('makes.index') }}" class="px-5 py-2 rounded-lg bg-gray-200 text-gray-700 hover:bg-gray-300 transition">Cancel</a>
            <button type="submit" class="px-6 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition">Update Make</button>
        </div>
    </form>
</div>
@endsection