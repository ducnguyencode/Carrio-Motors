...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link <?php echo e(request()->is('admin') ? 'active' : ''); ?>" href="<?php echo e(route('admin.dashboard')); ?>">
...
<?php /**PATH C:\Users\Tu5k\study\php\Carrio-Motors\resources\views/layouts/admin.blade.php ENDPATH**/ ?>