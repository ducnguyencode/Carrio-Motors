        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="carsDropdown">
                            <li><a class="dropdown-item" href="<?php echo e(route('cars')); ?>">All Cars</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('featured.cars')); ?>">Featured Cars</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('brands')); ?>">Browse by Brand</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('car.compare')); ?>">Compare Cars</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('blog')); ?>"><i class="bi bi-newspaper me-1"></i> Blog</a>
                    </li>
                </ul>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a class="nav-link p-0" href="<?php echo e(route('wishlist')); ?>">
