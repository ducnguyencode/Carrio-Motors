...
<?php $__env->startSection('page-heading', 'Edit User'); ?>
    ...
    <form action="<?php echo e(route('admin.users.update', $user)); ?>" method="POST" class="space-y-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="relative">
                ...
                <input type="text" name="username" id="username" value="<?php echo e(old('username', $user->username)); ?>" class="w-full pt-7 pb-2 px-4 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-400 focus:outline-none text-base bg-gray-50 shadow-sm <?php $__errorArgs = ['username'];
...
unset($__errorArgs, $__bag); ?>" required autocomplete="off">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="relative">
                ...
                <input type="text" name="fullname" id="fullname" value="<?php echo e(old('fullname', $user->fullname)); ?>" class="w-full pt-7 pb-2 px-4 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-400 focus:outline-none text-base bg-gray-50 shadow-sm <?php $__errorArgs = ['fullname'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="relative">
                ...
                <input type="email" name="email" id="email" value="<?php echo e(old('email', $user->email)); ?>" class="w-full pt-7 pb-2 px-4 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-400 focus:outline-none text-base bg-gray-50 shadow-sm <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="relative">
                ...
                <input type="text" name="phone" id="phone" value="<?php echo e(old('phone', $user->phone)); ?>" class="w-full pt-7 pb-2 px-4 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-400 focus:outline-none text-base bg-gray-50 shadow-sm <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="relative">
                ...
                <input type="text" name="address" id="address" value="<?php echo e(old('address', $user->address)); ?>" class="w-full pt-7 pb-2 px-4 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-400 focus:outline-none text-base bg-gray-50 shadow-sm <?php $__errorArgs = ['address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="relative">
                ...
                <input type="password" name="password" id="password" class="w-full pt-7 pb-2 px-4 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-400 focus:outline-none text-base bg-gray-50 shadow-sm <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="relative">
                ...
                <?php else: ?>
                    <select name="role" id="role" class="w-full pt-7 pb-2 px-4 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-400 focus:outline-none text-base bg-gray-50 shadow-sm <?php $__errorArgs = ['role'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                        ...
                        <?php if($user->role == 'admin' || !$adminExists): ?>
                        <option value="admin" <?php echo e((old('role', $user->role) == 'admin') ? 'selected' : ''); ?>>Admin</option>
                        <?php endif; ?>
                        <option value="content" <?php echo e((old('role', $user->role) == 'content') ? 'selected' : ''); ?>>Content</option>
                        <option value="saler" <?php echo e((old('role', $user->role) == 'saler') ? 'selected' : ''); ?>>Saler</option>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex items-center mt-8">
                <input type="checkbox" name="is_active" id="is_active" class="h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300 rounded mr-2" <?php echo e(old('is_active', $user->is_active) ? 'checked' : ''); ?>>
                <label for="is_active" class="block text-base text-gray-700">Active Account</label>
            </div>
        </div>
        <div class="flex justify-end gap-2 mt-8">
            <a href="<?php echo e(route('admin.users.index')); ?>" class="px-5 py-2 rounded-lg bg-gray-200 text-gray-700 hover:bg-gray-300 font-medium transition">Cancel</a>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/Carrio-Motors/resources/views/admin/users/edit.blade.php ENDPATH**/ ?>