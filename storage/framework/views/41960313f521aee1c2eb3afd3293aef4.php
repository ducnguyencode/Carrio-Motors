    ...
    <div class="carousel-slide <?php echo e($index == 0 ? 'active' : ''); ?>">
        <a href="<?php echo e($banner->click_url ?? ($banner->car_id ? route('car.detail', $banner->car_id) : '#')); ?>" class="video-link">
            ...
            <div class="carousel-content">
                ...
                <p><?php echo e($banner->main_content); ?></p>
            </div>
        </a>
    </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 hero-content">
                ...
                <a href="<?php echo e(route('cars')); ?>" class="btn btn-primary btn-lg">View All Cars</a>
            </div>
            <div class="col-lg-6">
                <img src="<?php echo e(asset('images/car_dealership_showroom.jpg')); ?>" class="img-fluid rounded shadow" alt="Car Banner">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="car-card" data-car-id="<?php echo e($car['id']); ?>" data-car-json="<?php echo e(json_encode($car)); ?>">
                    <div class="car-image">
                    ...
                    <div class="car-content">
                        <h3 class="car-title"><?php echo e($car['name']); ?></h3>
                        <div class="car-rating">
                            <span class="rating"><?php echo e($car['rating']); ?></span>
                            <span class="text-warning">
                                <i class="fas fa-star"></i>
                            </span>
                            <span class="ms-1 text-muted">(<?php echo e($car['reviews']); ?> reviews)</span>
                        </div>
                        <div class="car-price">$<?php echo e(number_format($car['price'])); ?></div>
                        <div class="car-specs">
                            <span class="spec spec-engine"><?php echo e($car['engine']); ?></span>
                            <span class="spec spec-fuel"><?php echo e($car['fuel_type']); ?></span>
                            <span class="spec spec-transmission"><?php echo e($car['transmission']); ?></span>
                        </div>
                        <a href="/cars/<?php echo e($car['id']); ?>" class="car-button">View Details</a>
                    </div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="text-center mt-5">
            <a href="<?php echo e(route('cars')); ?>" class="btn btn-primary btn-lg">Show More Cars</a>
        </div>
    </div>
</section>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between mb-3">
                            <div class="d-flex align-items-center">
                                <img src="<?php echo e(asset('images/testimonials/testimonial-1.jpg')); ?>" class="rounded-circle me-3" width="60" height="60" alt="Customer">
                                <div>
            ...
            <div class="col-lg-4 mb-4">
                <div class="card border-0 shadow h-100">
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between mb-3">
                            <div class="d-flex align-items-center">
                                <img src="<?php echo e(asset('images/testimonials/testimonial-2.jpg')); ?>" class="rounded-circle me-3" width="60" height="60" alt="Customer">
                                <div>
            ...
            <div class="col-lg-4 mb-4">
                <div class="card border-0 shadow h-100">
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between mb-3">
                            <div class="d-flex align-items-center">
                                <img src="<?php echo e(asset('images/testimonials/testimonial-3.jpg')); ?>" class="rounded-circle me-3" width="60" height="60" alt="Customer">
                                <div>
