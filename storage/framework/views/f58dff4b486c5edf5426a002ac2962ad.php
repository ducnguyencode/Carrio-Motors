            ...
            <div class="flex flex-col w-64 bg-gray-800">
                ...
                <div class="flex flex-col flex-grow overflow-y-auto">
                    <nav class="flex-1 px-2 py-4 space-y-1">
                        <a href="<?php echo e(auth()->user()->role === 'user' ? url('/dashboard') : route('admin.dashboard')); ?>" class="flex items-center px-2 py-2 text-sm font-medium text-white rounded-md hover:bg-gray-700">
                            <i class="mr-3 text-lg fas fa-tachometer-alt"></i>
                            Dashboard
                        </a>
                        <?php if(auth()->user()->role === 'admin'): ?>
                        <a href="<?php echo e(route('admin.users.index')); ?>" class="flex items-center px-2 py-2 text-sm font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white">
...
<?php /**PATH D:\Project\Carrio-Motors\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>